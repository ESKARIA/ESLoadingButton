...
open class ESLineScalePulseIndicator: ESIndicator {
    ...
    open override func setupAnimation(in layer: CALayer, size: CGSize) {
        ...
        // Draw lines
        for i in 0 ..< 5 {
            let line = ESNVActivityIndicatorShape.line.layerWith(size: CGSize(width: lineSize, height: size.height), color: color)
