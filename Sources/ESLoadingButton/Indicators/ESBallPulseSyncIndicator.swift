...
open class ESBallPulseSyncIndicator: ESIndicator {
    ...
    open override func setupAnimation(in layer: CALayer, size: CGSize) {
        ...
        // Draw circles
        for i in 0 ..< 3 {
            let circle = ESNVActivityIndicatorShape.circle.layerWith(size: CGSize(width: circleSize, height: circleSize), color: color)
