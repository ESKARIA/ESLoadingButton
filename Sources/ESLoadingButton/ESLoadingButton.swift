...
open class ESLoadingButton: UIButton {
     ...
     */
    open var indicator: UIView & ESIndicatorProtocol = UIActivityIndicatorView()
    /**
     ...
     */
    open func showLoader(userInteraction: Bool, _ completion: ESLBCallback = nil) {
        showLoader([titleLabel, imageView], userInteraction: userInteraction, completion)
    }

    private func showLoader(_ viewsToBeHide: [UIView?], userInteraction: Bool = false, _ completion: ESLBCallback = nil) {
    ...
    /**
     ...
     - Parameter completion: The completion handler.
     */
    open func hideLoader(_ completion: ESLBCallback = nil) {
        guard self.subviews.contains(indicator) else { return }
        isLoading = false
...
extension UIActivityIndicatorView: ESIndicatorProtocol {
